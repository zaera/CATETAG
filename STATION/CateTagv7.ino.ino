...
//-------------------------------------------------------------------------- ---------------------------------------------------------
void success(){digitalWrite(led, HIGH);digitalWrite(buzzPin, HIGH); delay(1); digitalWrite(led, LOW); }
//-----------------------------------------------------------------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------------------------------------------------------------
void rmode(){digitalWrite(led, HIGH);digitalWrite(buzzPin, HIGH);
delay(100);
  ...
  if (point == 1)
{
 ...
 //Serial.print(F("Number of bytes that match = ")); Serial.println(count);
    if (count == 16) {
     digitalWrite(led, HIGH);digitalWrite(buzzPin, HIGH); digitalWrite(buzzPin, LOW); delay(1); digitalWrite(led, LOW); digitalWrite(buzzPin, HIGH);
     // success();      
  }
      //  else {
...
byte size = sizeof(buffer);
  ...
  // -----------------------------Write data to the block
    ...
    Serial.print(F("Number of bytes that match = ")); Serial.println(count);
    if (count == 16) {Serial.println(F("Success :-)")); digitalWrite(led, HIGH);digitalWrite(buzzPin, HIGH); delay(1); digitalWrite(led, LOW);//success();       
